...
def extract_job(html):
  ...
  company, location = html.find("h3", {"class": "mb4"}).find_all("span", recursive=False) # recursive : 더 깊에 안 들어가게 함, 즉 다 가져오지 않고 같은 레벨의 요청 값만 가져옴. 예를 들어 span 안에 또 span이 있으면 그 span은 가져오지 않음
